...
public class DocumentTest extends TestCase {
    ...
    public void testSelect() throws Exception {
        ...
        assertTrue(Utils.select(document, new Point(1,1), 8).size() == 1);
        assertTrue(Utils.select(document, new Point(1,1), 8).firstElement().getID() == c.getID());
    }
    ...
    public void testConstructorGrid() throws Exception {
        Document document = Utils.createGridWithSquares(new Point(0,0), 3, 3, 5);
    ...
    public void testConstructorCircle() throws Exception {
        assertEquals(Utils.createGridWithConcentricCercles(new Point(0,0), 4, 3., 4.).getObjectNumber(), 4);
    }
}